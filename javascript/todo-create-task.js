class Todo {
    selectors = {
        ...
        deleteAlButton: '[data-js-todo-delete-all-button]',
    ...
    constructor() {
        ...
        this.deleteAllButtonElement = this.rootElement.querySelector(this.selectors.deleteAlButton)
        this.listElement = this.rootElement.querySelector(this.selectors.list)
        this.emptyMassageElement = this.rootElement.querySelector(this.selectors.emptyMessage)
        this.state = {
    ...
    onDeleteAllButtonClick = () => {
        const isConfirmed = confirm('Хочешь всё удалить ? :(')
